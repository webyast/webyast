#
# spec file for package yast2-webservice-yast_commandline (Version 0.1)
#
...
Name:           yast2-webservice-yast_commandline
...
Source:         www.tar.bz2
Source1:        org.opensuse.yast.yast.commandline.policy
BuildRoot:      %{_tmppath}/%{name}-%{version}-build
BuildArch:      noarch

#
%define pkg_user yastws
%define plugin_name yast_commandline
#
