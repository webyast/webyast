...
class UserTest < Test::Unit::TestCase
  ...
  def setup
    parameters = {
      'user_attributes' => ['as', ['cn', 'uidNumber', 'homeDirectory', 'grouplist', 'uid', 'loginShell', 'groupname']],
      'type' => 'local', 'index' => ['s', 'uid']
    }
    result = {
      "testuser1"=>{ "cn"=>"testuser1", "groupname"=>"users", "uidNumber"=>1000, "homeDirectory"=>"/home/testuser1"},
